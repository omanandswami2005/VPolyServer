...
//   return (
//     <>
//       <h1 className="text-center my-3 d-block bg-dark text-white w-75 mx-auto border">Add Students</h1>
//     <Container className="my-3">
//       <Form onSubmit={handleStudentSubmit}>
//         <Row className="mb-3">
//           <Col>
...
//         </Row>
//         <Row>
//           <Col className='border mt-3 cursor-pointer'>
//             <a href="#"><div {...getRootProps()} className={`dropzone ${isDragActive ? 'active' : ''}`}>
//               <input {...getInputProps()} />
